  ...
  <nav class="navbar navbar-expand-md bg-white shadow-lg">
    ...
    <div class="dropdown">
      ...
      <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
        <li><a class="dropdown-item" href="{{ route('account.product.category.elctronic') }}">Electronics</a></li>
            ...
            <a href="#" class="text-decoration-none text-dark">
              <div class="card product-card h-100 border-0 shadow-sm">
                ...
                <div class="card-body p-2">
                  ...
                  <a href="{{ route('account.order', $item->id) }}" class="btn btn-primary sm">Buy Now</a>
                </div>
              </div>
            </a>
          </div>
