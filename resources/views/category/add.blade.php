        ...
        <div class="card">
           ...
           <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="card shadow-sm border-0">
                ...
                <div class="card-body">
                <form id="userForm" method="POST" action="{{ route('category.store') }}" enctype="multipart/form-data">                        @csrf
                        ...
                        <!-- Allow Match Checkbox -->
                        <div class="form-check mb-4">
                            <input class="form-check-input" type="checkbox" id="allowmatch" name="allowmatch">
                            <label class="form-check-label" for="allowmatch">Allow Match</label>
                        </div>
